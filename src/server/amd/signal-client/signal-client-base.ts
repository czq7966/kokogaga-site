...
export interface ISignalClientBase extends Modules_Namespace.ISocketNamespace {
    isReady(): boolean
    sendCommand(data: ADHOCCAST.Cmds.Common.ICommandData<any>): Promise<any>
    ...
    deliverUserCommand(sckUser: ISocketUser, cmd: ADHOCCAST.Dts.ICommandData<any>, includeSelf: boolean): Promise<any>
...
export class SignalClientBase extends Modules_Namespace.SocketNamespace implements ISignalClientBase {
    ...
    async deliverUserCommand(sckUser: ISocketUser, cmd: ADHOCCAST.Dts.ICommandData<any>, includeSelf: boolean) {
        ...
        return await this.deliverCommand(cmd, extra);
    }
