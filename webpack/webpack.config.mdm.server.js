...
module.exports = env => {
    ...
    const distDir = path.resolve(__dirname, '../dist/mdm/server');
    const srcDir =  path.resolve(__dirname, '../src/server');
    entry['index'] = path.resolve(srcDir, "index.ts");

    //amd
    entry['amd/common/index'] = path.resolve(srcDir, "amd/common/index.ts");
    entry['amd/cert-watcher/index'] = path.resolve(srcDir, "amd/cert-watcher/index.ts");
    entry['amd/admin/index'] = path.resolve(srcDir, "amd/admin/index.ts");    
